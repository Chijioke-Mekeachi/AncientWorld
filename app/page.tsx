...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">
            Journey Through time with meticulously researched articles and books that bring ancient civilization to life. Explore philosophies, Histories, and traditions that shaped our world.
          </p>
          <Link 
            href="/ebooks"
      ...
      {/* Featured Books Section - Now shows your actual books */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-3">Any Device</h3>
