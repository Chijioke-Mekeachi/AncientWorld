        ...
        <div className="max-w-2xl mx-auto text-center md:text-center flex flex-col gap-6">
          <div>
            ...
            <p className="text-[15px] md:text-xl mb-4">
              Journey through time with meticulously researched articles and books that bring ancient civilizations to life. Explore philosophies, histories, Pictorial, Videos and traditions that shaped our world and reflections on contemporary issues
            </p>
          </div>
